...
class clsPersonal:
    def __init__(self, dni, nombres, apellidos, telefono, correo, password,
        ...
        with conn:
            with conn.cursor() as cursor:
                sql = """
                    ...
                    (dni, nombres, apellidos, telefono, correo, password,
                     tipo_usuario, area, puesto, fecha_ingreso)
...
def verificar_credenciales(dni, password):
    try:
        ...
        with conexion:
            with conexion.cursor(pymysql.cursors.DictCursor) as cursor:  # 👈 DictCursor
                query = """
